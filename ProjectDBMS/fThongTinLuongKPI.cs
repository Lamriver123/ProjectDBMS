...
{
    public partial class fThongTinLuongKPI : Form
    {
        private int MaNV;
        public fThongTinLuongKPI()
        {
            InitializeComponent();
        ...
        public fThongTinLuongKPI(DataRow dr)
        {
            InitializeComponent();
            txtNam.Text = DateTime.Now.Year.ToString();
            addThang(DateTime.Now.Month);
            ...
            DataRow dr2 = NhanVienDAO.LaySoLuongSPVaTienSP(fDangNhap.MaNV, DateTime.Now);
            txtTienSanPham.Text = dr2["SoLuongSP"].ToString();
            txtSanPhamLamDuoc.Text = dr2["TongTienChiTieu"].ToString();
        ...
        private void txtThang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataRow dr2 = NhanVienDAO.LaySoLuongSPVaTienSP(fDangNhap.MaNV, ngay);
            txtTienSanPham.Text = dr2["SoLuongSP"].ToString();
            txtSanPhamLamDuoc.Text = dr2["TongTienChiTieu"].ToString();
        }
